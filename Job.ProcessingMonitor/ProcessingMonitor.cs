...
namespace RecurringIntegrationsScheduler.Job
{
    ...
    public class ProcessingMonitor : IJob
    {
        ...
        public async Task Execute(IJobExecutionContext context)
        {
            ...
            string processingSuccessDir = dataMap.GetString(SettingsConstants.ProcessingSuccessDir);
            string processingErrorsDir = dataMap.GetString(SettingsConstants.ProcessingErrorsDir);
            ...
            try
            {
                ...
                foreach (string company in FileHelper.getCompanysFromPath(uploadSuccessDir, placeHolder, origCompany))
                {
                    ...
                    dataMap.Put(SettingsConstants.ProcessingSuccessDir, processingSuccessDir.Replace(placeHolder, company));
                    dataMap.Put(SettingsConstants.ProcessingErrorsDir, processingErrorsDir.Replace(placeHolder, company));
                    ...
                    dataMap.Put(SettingsConstants.ProcessingSuccessDir, processingSuccessDir);
                    dataMap.Put(SettingsConstants.ProcessingErrorsDir, processingErrorsDir);
